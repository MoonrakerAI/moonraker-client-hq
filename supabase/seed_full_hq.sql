...
BEGIN
    ...
    -- Robyn Sevigny
    INSERT INTO practices (name, status, start_date, contact_name, email, website, gbp_link, campaign_link, notes) VALUES ('Robyn Sevigny', 'LMFT', 'Done', '7/22/2025', 'Robyn Sevigny', 'robyn.mft@gmail.com', 'https://www.robynsevigny.com/', 'https://business.google.com/n/8795558797113923135/profile?fid=16878475790203610415', '') RETURNING id INTO p_id;

    INSERT INTO workflow_tasks (practice_id, name, status, category, stage, display_order) VALUES (p_id, 'System Access & Permissions', 'https://docs.google.com/spreadsheets/d/1u2ICLV-Q5R3s_fLU0TKxJKIcip0xmbRq_xtfE3kkoh8/edit?usp=sharing', 'Access', 'Pre-Kickoff', 1);
    INSERT INTO workflow_tasks (practice_id, name, status, category, stage, display_order) VALUES (p_id, 'Neo Creative Implementation', 'Open', 'Creative', 'Execution Phase', 6);
